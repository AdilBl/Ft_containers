...
class const_map_iterator
{
	public:
        ...
        bool    operator!=(const const_map_iterator& x)    {return (this->index != x.index);}
        //
        difference_type     operator+(const const_map_iterator& x)  {return (this->index->content.second + x.index.content.second);}
        difference_type     operator-(const const_map_iterator& x)  {return (this->index->content.second - x.index.content.second);}
        
        void    operator+=(const const_map_iterator& x)  {return (this->index += x.index);}
        void    operator-=(const const_map_iterator& x)  {return (this->index -= x.index);}
